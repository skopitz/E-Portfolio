...
## Capstone - Post-Fire Spectral Recovery in Northern Manitoba

**University of British Columbia, MGEM Capstone** ([doi link](https://doi.org/10.5683/SP3/MO1W5K))

This capstone examined vegetation recovery following a 2013 wildfire complex that burned about 168,837 hectares in the Boreal Shield of northern Manitoba, near Gillam and nearby First Nations and Northern Affairs communities. Using Landsat surface reflectance imagery from 2010 to 2023, I looked at how burn severity and pre-fire land cover influenced recovery patterns over the first decade after the fire.

**What I did**

-   Built annual vegetation index time series from Landsat imagery
-   Mapped burn severity using a pre-fire and post-fire satellite comparison
-   Calculated recovery rate and estimated years to recovery
-   Compared recovery across burn severity classes and pre-fire land-cover types
-   Created maps, graphs, and summary figures to communicate the results

**[VIEW R CODE AND PROJECT CONTENT](capstone_recovery.html)**\
**[VIEW PAPER](files/Kopitz_Wildfire_Recovery_Final_Paper.pdf)**
...
- Segmented trees using *[Li et al. (2012)](https://doi.org/10.14358/PERS.78.1.75)* point-cloud method and *[Dalponte & Coomes (2016)](https://doi.org/10.1111/2041-210X.12575)* Canopy Height Model(CHM) - based method
...
*University of Winnipeg - water quality lab*
...
## Managing Wildfire Risk After Mountain Pine Beetle

**University of Winnipeg**

This paper was written for a course during my undergrad, where I researched a topic related to forest health and protection, presented on it, and then wrote this paper. It looks at how wildfire risk changes over time following mountain pine beetle (MPB) outbreaks, and evaluates three management strategies used to reduce that risk: prescribed burning, mechanical thinning, and salvage logging. It draws on two BC case studies, the Mitchell Ridge prescribed burn and Central Chilcotin Rehabilitation Ltd.'s Indigenous-led forest recovery work, to look at how effective each strategy is depending on timing and local conditions.

**[VIEW PAPER](files/Kopitz_FinalPaper_ForestProtection_UPDATED.pdf)**
